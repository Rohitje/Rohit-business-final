            ...
            <div class="row no-gutters clients-wrap clearfix" data-aos="fade-up">
                ...
                <div class="col-lg-3 col-md-4 col-6">
                    <div class="brand-logo">
                        <img src="{{ $brand -> brand_image }}" class="img-fluid" alt="" style="width:250px; height:200px">
                    </div>
                </div>
                @endforeach
            </div>
